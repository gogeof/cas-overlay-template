...
public class CertHandleUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(org.szwj.ca.identityauthsrv.util.bussiness.CertHandleUtil.class);
